...
PARAMETER_DEFAULTS = (
    ...
    ('minimum_useful_exploration_speed_mps', 0.03),
    ('navigation_progress_distance_m', 0.05),
    ('navigation_no_progress_timeout', 12.0),
    ('max_consecutive_navigation_no_progress', 2),
...
def validate_parameters(config):
    ...
    for name in (
            ...
            'minimum_useful_exploration_speed_mps',
            'navigation_progress_distance_m',
            'navigation_no_progress_timeout',
    ...
    for name in (
            ...
            'max_consecutive_navigation_no_progress',
