...
def generate_launch_description():
    ...
    use_namespace_arg = DeclareLaunchArgument(
        ...
        default_value='False',
        description=(
            'Whether to apply a namespace to the Nav2 action/planner/'
            'controller/smoother bringup.'
        ),
    )
    params_file_arg = DeclareLaunchArgument(
        ...
        description=(
            'Path to the Nav2 parameter file for BT navigator, controller, '
            'planner, smoother, and costmaps.'
        ),
    )
