...
def generate_launch_description():
    ...
    use_namespace_arg = DeclareLaunchArgument(
        "use_namespace",
        default_value="False",
        description="Whether to apply a namespace to the costmap bringup.",
    )
    params_file_arg = DeclareLaunchArgument(
        "params_file",
        default_value=default_params_file,
        description="Path to the Nav2 parameter file. This launches only the Nav2 servers that own costmaps.",
    )
    ...
    start_costmap_servers = GroupAction([
