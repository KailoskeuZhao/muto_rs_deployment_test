...
def build_planner_prompt(board: MissionBoard, *, visual_available: bool) -> str:
    ...
    return (
        ...
        "search_progress is the count of completed bounded observation cycles, "
        "not a percentage and not proof of exhaustion. "
        "last_reason_code=frontier_cycle_completed means only that one bounded "
        "cycle ended cooperatively; it is not frontier exhaustion. Only "
