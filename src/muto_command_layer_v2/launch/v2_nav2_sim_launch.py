...
def generate_launch_description():
    ...
    args = [
        ...
        DeclareLaunchArgument(
            "frontier_completion_topic", default_value="/explore/exploration_complete"
        ),
        ...
        parameters=[
            {
                ...
                "frontier_completion_topic": LaunchConfiguration("frontier_completion_topic"),
                "frontier_observe_duration_s": LaunchConfiguration("frontier_observe_duration_s"),
