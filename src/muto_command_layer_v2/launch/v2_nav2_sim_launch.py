...
The VLM and object registry remain external authorities; the deterministic
POI-grid search authority is mounted by the v2 executive.  This launch only
supplies the executive, environment fixture, and existing Nav2 pipeline.
"""
...
def generate_launch_description():
    ...
    args = [
        ...
        DeclareLaunchArgument(
            "poi_grid_selected_pose_topic", default_value="/muto/poi_grid/selected_pose"
        ),
